...
import 'package:snippett/Domain/Models/drawerModels/drawermodelsUser/about_cmpany_common.dart';
...
class aboutCompanyUser extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => aboutCompanyUserModel(),
      child: const subAboutCopmanyUser(),
    );
  }
}

class subAboutCopmanyUser extends StatelessWidget {
  const subAboutCopmanyUser({super.key});
