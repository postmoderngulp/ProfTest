...
import 'package:snippett/Domain/Models/AdminModels/create_material_hr_model.dart';
...
class CreateMaterialHr extends StatelessWidget {
  const CreateMaterialHr({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => createMaterialHrModel(),
      child: const subCreateMaterialHr(),
    );
  }
}

class subCreateMaterialHr extends StatelessWidget {
  const subCreateMaterialHr({super.key});
...
class nameTextField extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final model = context.watch<createMaterialHrModel>();
    return Center(
      child: SizedBox(
        width: 354.w,
        height: 40.h,
